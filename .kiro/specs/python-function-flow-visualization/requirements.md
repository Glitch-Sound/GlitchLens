...
5. When Python の可視化結果が Mermaid テキストとして表示またはコピーされる, the GlitchLens extension shall 共通 Requirement 16 と同じ無題の左端ライフライン、主体ライフライン、操作メッセージ、unknown / unresolved 表示、および処理順序を保持する
